...
${OBJECTDIR}/BitAlgo.o: BitAlgo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BitAlgo.o BitAlgo.cpp

${OBJECTDIR}/Creational/BoostDI.o: Creational/BoostDI.cpp
	${MKDIR} -p ${OBJECTDIR}/Creational
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Creational/BoostDI.o Creational/BoostDI.cpp

${OBJECTDIR}/Creational/ISP.o: Creational/ISP.cpp
	${MKDIR} -p ${OBJECTDIR}/Creational
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Creational/ISP.o Creational/ISP.cpp

${OBJECTDIR}/Creational/LSP.o: Creational/LSP.cpp
	${MKDIR} -p ${OBJECTDIR}/Creational
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Creational/LSP.o Creational/LSP.cpp

${OBJECTDIR}/Creational/OCP.o: Creational/OCP.cpp
	${MKDIR} -p ${OBJECTDIR}/Creational
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Creational/OCP.o Creational/OCP.cpp

${OBJECTDIR}/Creational/SRP.o: Creational/SRP.cpp
	${MKDIR} -p ${OBJECTDIR}/Creational
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Creational/SRP.o Creational/SRP.cpp

${OBJECTDIR}/DynamicAlgo.o: DynamicAlgo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DynamicAlgo.o DynamicAlgo.cpp

${OBJECTDIR}/FunctionOverloading.o: FunctionOverloading.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionOverloading.o FunctionOverloading.cpp
...
${OBJECTDIR}/MutableExample.o: MutableExample.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MutableExample.o MutableExample.cpp

${OBJECTDIR}/ObjectRelated.o: ObjectRelated.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ObjectRelated.o ObjectRelated.cpp
...
${OBJECTDIR}/STLExample.o: STLExample.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/STLExample.o STLExample.cpp

${OBJECTDIR}/StructLinkedList.o: StructLinkedList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StructLinkedList.o StructLinkedList.cpp

${OBJECTDIR}/StructStack.o: StructStack.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StructStack.o StructStack.cpp
...
${OBJECTDIR}/lambda.o: lambda.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lambda.o lambda.cpp
